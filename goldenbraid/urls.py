...
urlpatterns = [
    ...
    url(r'^do/crispr/cas9_single$', crispr_view_cas9_single, name='cas9_single_domestication'),
    url(r'^do/crispr/cas9_multiplexing$', crispr_view_cas9_multiplexing, name='cas9_multiplexing_domestication'),
    url(r'^do/crispr/cas9_multiplexing/auto/(?P<section>.+)?/?$', crispr_view_cas9_multiplexing_auto, name='cas9_multiplexing_domestication_auto'),
    ...
    url(r'^do/crispr/cas12_single$', crispr_view_cas12_single, name='cas12_single_domestication'),
    url(r'^do/crispr/cas12_single/assemble_tu$', crispr_view_cas12_single_TU, name='cas12_single_tu'),
    url(r'^do/crispr/cas12_multiplexing_2X$', crispr_view_cas12_multiplexing_2X, name='cas12_multiplexing_domestication_2X'),
    url(r'^do/crispr/cas12_multiplexing_3X$', crispr_view_cas12_multiplexing_3X, name='cas12_multiplexing_domestication_3X'),
    url(r'^do/crispr/cas12_multiplexing_4X$', crispr_view_cas12_multiplexing_4X, name='cas12_multiplexing_domestication_4X'),
    url(r'^do/crispr/cas12_multiplexing_5X$', crispr_view_cas12_multiplexing_5X, name='cas12_multiplexing_domestication_5X'),
    url(r'^do/crispr/cas12_multiplexing_6X$', crispr_view_cas12_multiplexing_6X, name='cas12_multiplexing_domestication_6X'),
    ...
    url(r'^do/crispr/cas12a_multiplexing/tu', crispr_view_cas12a_multiplexing_TU, name="cas12a_multiplex_tu"),
    url(r'^do/crispr/level0/add/$', level_0_add, name='crispr_level0_add'),
    url(r'^do/crispr/level0_editing/(?P<section>.+)?/?$', level_0_editing, name='crispr_level0_editing'),
    url(r'^do/crispr/level0_regulation/(?P<section>.+)?/?$', level_0_regulation, name='crispr_level0_regulation'),
