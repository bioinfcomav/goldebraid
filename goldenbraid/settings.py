...
PARTS_TO_ASSEMBLE = {'basic': [CATEGORIES[PROM_5UTR_NTAG],
                     ...
                     'gRNA_dicot': [CRYSPER_CATEGORIES[PROM_DICOT],
                                    ...
                                    CRYSPER_CATEGORIES[TER_CRYSPER]],
                     'single_cas9_regulatory_monocot': [CRYSPER_CATEGORIES[PROM_MONOCOT],
                                                        CRYSPER_CATEGORIES[TARGET_MONOCOT],
                                                        CRYSPER_CATEGORIES[TER_CRYSPER]],
                     'single_cas9_regulatory_dicot': [CRYSPER_CATEGORIES[PROM_DICOT],
                                                CRYSPER_CATEGORIES[TARGET_DICOT],
                                                CRYSPER_CATEGORIES[TER_CRYSPER]],
                     ...
                     'crispr_inducible_regulation_1': [CATEGORIES[PROM_5UTR_NTAG],
...
TU_ASSEMBLER_TITLES = {"gRNA_dicot": "Single Cas9 gRNA Assembler, dicot (tS9A)",
                       ...
                       'crispr_edit_dicot_1': "Multiple Cas9 gRNA Assembler (tM9A)", 
                       'crispr_edit_dicot_2': "Multiple Cas9 gRNA Assembler (tM9A)", 
                       'crispr_edit_dicot_3': "Multiple Cas9 gRNA Assembler (tM9A)", 
                       ...
                       'crispr_edit_monocot_5': "Multiple Cas9 gRNA Assembler, (tM9A)",
                       'crispr_edit_monocot_6': "Multiple Cas9 gRNA Assembler, (tM9A)",
