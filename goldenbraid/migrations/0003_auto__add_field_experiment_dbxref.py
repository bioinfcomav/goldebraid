...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.dbxref'
        db.add_column('experiment', 'dbxref',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['goldenbraid.Dbxref']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Experiment.dbxref'
        db.delete_column('experiment', 'dbxref_id')
