...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExperimentSubFeature'
        ...
        db.send_create_signal(u'goldenbraid', ['ExperimentSubFeature'])

        # Adding unique constraint on 'ExperimentSubFeature', fields ['experiment', 'feature']
        db.create_unique(u'experimentkeysubfeature', ['experiment_id', 'feature_id'])

        # Deleting field 'ExperimentFeature.role'
        db.delete_column(u'experimentfeature', 'role_id')


    def backwards(self, orm):
        # Removing unique constraint on 'ExperimentSubFeature', fields ['experiment', 'feature']
        db.delete_unique(u'experimentkeysubfeature', ['experiment_id', 'feature_id'])
        ...
        # Deleting model 'ExperimentSubFeature'
        db.delete_table(u'experimentkeysubfeature')

        # Adding field 'ExperimentFeature.role'
        db.add_column(u'experimentfeature', 'role',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['goldenbraid.Cvterm']),
                      keep_default=False)
    ...
    models = {
        ...
        u'goldenbraid.experimentsubfeature': {
            'Meta': {'unique_together': "(('experiment', 'feature'),)", 'object_name': 'ExperimentSubFeature', 'db_table': "u'experimentkeysubfeature'"},
            'experiment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['goldenbraid.Experiment']"}),
